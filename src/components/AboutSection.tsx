      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <span className="text-xs font-bold uppercase tracking-wider text-[#0A4EE4] bg-blue-50 border border-blue-200 px-3.5 py-1.5 rounded-full">
              Sobre a Opera Digital
            </span>

            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight leading-tight">
              Aceleração Digital e Tecnologia para <span className="text-[#0A4EE4]">alavancar seu negócio</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm text-slate-900">Sites de Alta Conversão</h4>
                  <p className="text-xs text-slate-500 mt-0.5">Design exclusivo, responsivo e preparado para o Google (SEO).</p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm text-slate-900">Automação no WhatsApp</h4>
                  <p className="text-xs text-slate-500 mt-0.5">Atendimento 24/7 com Agentes de IA e triagem ágil.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-gradient-to-br from-slate-900 to-slate-950 rounded-3xl p-8 text-white shadow-2xl relative border border-slate-800 space-y-6">
              ...
              <div className="space-y-3 pt-2">
                <div className="flex items-center justify-between p-3.5 bg-slate-800/80 rounded-xl text-xs">
