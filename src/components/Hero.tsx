        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 bg-blue-950/80 border border-blue-800/60 text-blue-400 px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm"
              >
          ...
          >
            <div className="bg-slate-900/90 rounded-2xl shadow-2xl border border-slate-800 overflow-hidden transform lg:rotate-1 hover:rotate-0 transition-transform duration-300">
              ...
              <div className="p-4 sm:p-6 bg-slate-950 min-h-[260px]">
            ...
            <motion.div 
              ...
              className="absolute -bottom-4 sm:-bottom-6 right-2 sm:-left-6 bg-slate-900/90 backdrop-blur-md p-3 sm:p-4 rounded-xl shadow-2xl border border-slate-800"
            >
